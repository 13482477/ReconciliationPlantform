package com.yonyou.reconciliation.requestmapping.controller;
...
import com.yonyou.reconciliation.ui.element.select2.Select2;
import com.yonyou.reconciliation.ui.element.select2.Select2ListResult;
...
public class RequestMappingController {
	...
	public Select2ListResult findRequestMappings(@RequestParam(name = "search", required = false) String search) {
		List<com.yonyou.reconciliation.requestmapping.dto.RequestMapping> requestMappings = this.requestMappingService.findRequestMappings(search);
